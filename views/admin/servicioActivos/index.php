...
<html>
<head>
	<title>Catalogo de Activos</title>
...
<div >
	<div>
		...
		<button class="btn btn-danger btn-sm "  data-direccion="admin/ServicioActivos/vwCatalogos/" class="btn btn-ban"  >
...
$("[data-buscar]").on("click",function(){
	var nombre =$("[name='buscar']").val();
	      if($.trim(nombre) != ""){ 
	          $.post("<?=site_url()?>/admin/ServicioActivos/buscar", {nombre: $("[name='buscar']").val()}, function(resp){
                $("#modulo").html(resp);
		          });
	         }
});
